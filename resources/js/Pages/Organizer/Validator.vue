        ...
        ">
            <div v-if="state.overlay.active" @click="state.overlay.active = false"
                ...
                <div class="h-60 flex flex-col">
                    <img class="h-40"
                        :src="state.ticket.event.cover_url" />
                ...
                <div v-if="state.ticket.status === 'non-used'" class="h-20 flex justify-center items-center text-white bg-green-400">
                ...
                <div v-if="state.ticket.status === 're-used'" class="h-20 flex justify-center items-center text-white bg-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
